...
RSpec.describe GramsController, type: :controller do
  ...
  describe "grams#destroy action" do
    it "should allow users who didn't create the gram destroy the gram" do
  ...
  describe "grams#update action" do
    ...
    it "it should have http 404 error if the gram cannot be found" do 
      user = FactoryGirl.create(:user)
      sign_in user
  ...
  describe "grams#edit action" do
    it "should let a user who did not create the gram edit a gram" do
      gram = FactoryGirl.create(:gram)
      user = FactoryGirl.create(:user)
      sign_in user
